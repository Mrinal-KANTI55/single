...
if(isset($_POST['done'])){
 ...
 $q = " update `blogDetail` set id = $id ,blogImage='$blogImage', blogAddress='$blogAddress', blogContact='$blogContact', blogEmail='$blogEmail', blogEvent_Offer='$blogEvent_Offer', blogService='$blogService' ";
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="card mt-3">
                ...
                <div class="card-header bg-dark">
                    <h1 class="text-white text-center">Update Blog Information </h1>
                </div><br>
